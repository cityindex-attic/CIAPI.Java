...
public class ApiOrderDTO {
	...
	private CIAPI.Java.dto.ApiStopLimitOrderDTO OcoOrder;
	
	/**
	 * Corresponding OcoOrder (One Cancels the Other)
	 */
	public CIAPI.Java.dto.ApiStopLimitOrderDTO getOcoOrder() {
		return OcoOrder;
	}
	
	public void setOcoOrder(CIAPI.Java.dto.ApiStopLimitOrderDTO OcoOrder) {
