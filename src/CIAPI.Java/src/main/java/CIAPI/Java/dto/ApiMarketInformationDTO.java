...
public class ApiMarketInformationDTO {
	...
	private CIAPI.Java.dto.ApiMarketEodDTO[] MarketEod;
	
	/**
	 * list of market end of day dtos.
	 */
	public CIAPI.Java.dto.ApiMarketEodDTO[] getMarketEod() {
		return MarketEod;
	}
	
	public void setMarketEod(CIAPI.Java.dto.ApiMarketEodDTO[] MarketEod) {
