...
public class ServiceMethodsImpl implements ServiceMethods {
	...
	public ApiLogOnResponseDTO LogOn(String UserName, String Password, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (ApiLogOnResponseDTO) api.callPostMethod(fullUrl, UserName, ApiLogOnResponseDTO.class);
		} else {
	...
	public Future<Object> LogOnAsync(String UserName, String Password, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, UserName, ApiLogOnResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ApiLogOffResponseDTO DeleteSession(String userName, String session, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (ApiLogOffResponseDTO) api.callPostMethod(fullUrl, userName, ApiLogOffResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> DeleteSessionAsync(String userName, String session, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, userName, ApiLogOffResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public GetPriceBarResponseDTO GetPriceBars(String marketId, String interval, int span, String priceBars, JsonApi api)
		...
		if (transport.equals("GET")) {
			...
			result = (GetPriceBarResponseDTO) api.callPostMethod(fullUrl, marketId, GetPriceBarResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> GetPriceBarsAsync(String marketId, String interval, int span, String priceBars,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, marketId, GetPriceBarResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public GetPriceTickResponseDTO GetPriceTicks(String marketId, String priceTicks, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (GetPriceTickResponseDTO) api.callPostMethod(fullUrl, marketId, GetPriceTickResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> GetPriceTicksAsync(String marketId, String priceTicks, AsyncJsonApi api,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, marketId, GetPriceTickResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public GetMarketInformationResponseDTO GetMarketInformation(String marketId, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (GetMarketInformationResponseDTO) api.callPostMethod(fullUrl, marketId,
	...
	public Future<Object> GetMarketInformationAsync(String marketId, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, marketId, GetMarketInformationResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ListMarketInformationSearchResponseDTO ListMarketInformationSearch(boolean searchByMarketCode,
		...
		if (transport.equals("GET")) {
			...
			result = (ListMarketInformationSearchResponseDTO) api.callPostMethod(fullUrl, searchByMarketCode,
					ListMarketInformationSearchResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public Future<Object> ListMarketInformationSearchAsync(boolean searchByMarketCode, boolean searchByMarketName,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, searchByMarketCode, ListMarketInformationSearchResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ListMarketInformationResponseDTO ListMarketInformation(int[] MarketIds, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (ListMarketInformationResponseDTO) api.callPostMethod(fullUrl, MarketIds,
					ListMarketInformationResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public Future<Object> ListMarketInformationAsync(int[] MarketIds, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, MarketIds, ListMarketInformationResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ListNewsHeadlinesResponseDTO ListNewsHeadlines(String category, int maxResults, JsonApi api)
		...
		if (transport.equals("GET")) {
			...
			result = (ListNewsHeadlinesResponseDTO) api.callPostMethod(fullUrl, category,
	...
	public Future<Object> ListNewsHeadlinesAsync(String category, int maxResults, AsyncJsonApi api,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, category, ListNewsHeadlinesResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public GetNewsDetailResponseDTO GetNewsDetail(String storyId, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (GetNewsDetailResponseDTO) api.callPostMethod(fullUrl, storyId, GetNewsDetailResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> GetNewsDetailAsync(String storyId, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, storyId, GetNewsDetailResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ListCfdMarketsResponseDTO ListCfdMarkets(String searchByMarketName, String searchByMarketCode,
		...
		if (transport.equals("GET")) {
			...
			result = (ListCfdMarketsResponseDTO) api.callPostMethod(fullUrl, searchByMarketName,
	...
	public Future<Object> ListCfdMarketsAsync(String searchByMarketName, String searchByMarketCode,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, searchByMarketName, ListCfdMarketsResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ListSpreadMarketsResponseDTO ListSpreadMarkets(String searchByMarketName, String searchByMarketCode,
		...
		if (transport.equals("GET")) {
			...
			result = (ListSpreadMarketsResponseDTO) api.callPostMethod(fullUrl, searchByMarketName,
	...
	public Future<Object> ListSpreadMarketsAsync(String searchByMarketName, String searchByMarketCode,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, searchByMarketName, ListSpreadMarketsResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ApiTradeOrderResponseDTO Order(int OrderId, int MarketId, String Currency, boolean AutoRollover,
		...
		if (transport.equals("GET")) {
			...
			result = (ApiTradeOrderResponseDTO) api.callPostMethod(fullUrl, OrderId, ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> OrderAsync(int OrderId, int MarketId, String Currency, boolean AutoRollover,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, OrderId, ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ApiTradeOrderResponseDTO UpdateOrder(JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (ApiTradeOrderResponseDTO) api.callPostMethod(fullUrl, null, ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> UpdateOrderAsync(AsyncJsonApi api, CallBack... callBacks) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, null, ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ListOpenPositionsResponseDTO ListOpenPositions(int tradingAccountId, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (ListOpenPositionsResponseDTO) api.callPostMethod(fullUrl, tradingAccountId,
	...
	public Future<Object> ListOpenPositionsAsync(int tradingAccountId, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, tradingAccountId, ListOpenPositionsResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ListActiveStopLimitOrderResponseDTO ListActiveStopLimitOrders(int tradingAccountId, JsonApi api)
		...
		if (transport.equals("GET")) {
			...
			result = (ListActiveStopLimitOrderResponseDTO) api.callPostMethod(fullUrl, tradingAccountId,
					ListActiveStopLimitOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public Future<Object> ListActiveStopLimitOrdersAsync(int tradingAccountId, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, tradingAccountId, ListActiveStopLimitOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public GetActiveStopLimitOrderResponseDTO GetActiveStopLimitOrder(String orderId, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (GetActiveStopLimitOrderResponseDTO) api.callPostMethod(fullUrl, orderId,
					GetActiveStopLimitOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public Future<Object> GetActiveStopLimitOrderAsync(String orderId, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, orderId, GetActiveStopLimitOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public GetOpenPositionResponseDTO GetOpenPosition(String orderId, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (GetOpenPositionResponseDTO) api
					.callPostMethod(fullUrl, orderId, GetOpenPositionResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> GetOpenPositionAsync(String orderId, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, orderId, GetOpenPositionResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ListTradeHistoryResponseDTO ListTradeHistory(int tradingAccountId, int maxResults, JsonApi api)
		...
		if (transport.equals("GET")) {
			...
			result = (ListTradeHistoryResponseDTO) api.callPostMethod(fullUrl, tradingAccountId,
	...
	public Future<Object> ListTradeHistoryAsync(int tradingAccountId, int maxResults, AsyncJsonApi api,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, tradingAccountId, ListTradeHistoryResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ListStopLimitOrderHistoryResponseDTO ListStopLimitOrderHistory(int tradingAccountId, int maxResults,
		...
		if (transport.equals("GET")) {
			...
			result = (ListStopLimitOrderHistoryResponseDTO) api.callPostMethod(fullUrl, tradingAccountId,
					ListStopLimitOrderHistoryResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public Future<Object> ListStopLimitOrderHistoryAsync(int tradingAccountId, int maxResults, AsyncJsonApi api,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, tradingAccountId, ListStopLimitOrderHistoryResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public GetOrderResponseDTO GetOrder(String orderId, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (GetOrderResponseDTO) api.callPostMethod(fullUrl, orderId, GetOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> GetOrderAsync(String orderId, AsyncJsonApi api, CallBack... callBacks) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, orderId, GetOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ApiTradeOrderResponseDTO Trade(int MarketId, String Currency, boolean AutoRollover, String Direction,
		...
		if (transport.equals("GET")) {
			...
			result = (ApiTradeOrderResponseDTO) api.callPostMethod(fullUrl, MarketId, ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> TradeAsync(int MarketId, String Currency, boolean AutoRollover, String Direction,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, MarketId, ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public AccountInformationResponseDTO GetClientAndTradingAccount(JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (AccountInformationResponseDTO) api.callPostMethod(fullUrl, null,
	...
	public Future<Object> GetClientAndTradingAccountAsync(AsyncJsonApi api, CallBack... callBacks) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, null, AccountInformationResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public ApiErrorResponseDTO GenerateException(int errorCode, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			...
			result = (ApiErrorResponseDTO) api.callPostMethod(fullUrl, errorCode, ApiErrorResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> GenerateExceptionAsync(int errorCode, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, errorCode, ApiErrorResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
