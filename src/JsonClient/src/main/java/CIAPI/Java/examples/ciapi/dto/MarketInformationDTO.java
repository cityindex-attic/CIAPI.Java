...
public class MarketInformationDTO {
	...
	private CIAPI.Java.examples.ciapi.dto.MarketEodDTO[] MarketEod;
	
	/**
	 * TODO
	 */
	public CIAPI.Java.examples.ciapi.dto.MarketEodDTO[] getMarketEod() {
		return MarketEod;
	}
	
	public void setMarketEod(CIAPI.Java.examples.ciapi.dto.MarketEodDTO[] MarketEod) {
