...
public class GatewayIfDoneDTO {
	...
	public void setStop(CIAPI.Java.examples.ciapi.dto.GatewayStopLimitOrderDTO Stop) {
		this.Stop = Stop;
	}
	...
	public void setLimit(CIAPI.Java.examples.ciapi.dto.GatewayStopLimitOrderDTO Limit) {
		this.Limit = Limit;
	}
