...
public class ServiceMethodsImpl implements ServiceMethods {
	...
	public CIAPI.Java.examples.ciapi.dto.CreateSessionResponseDTO CreateSession(
		...
		if (transport.equals("GET")) {
			// Concatenating the empty string is a hackey way of converting all
			// params to a String
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.CreateSessionResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.CreateSessionResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.CreateSessionResponseDTO) api.callPostMethod(fullUrl, logOnRequest,
					CIAPI.Java.examples.ciapi.dto.CreateSessionResponseDTO.class);
		} else {
	...
	public Future<Object> CreateSessionAsync(CIAPI.Java.examples.ciapi.dto.LogOnRequestDTO logOnRequest,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, logOnRequest,
					CIAPI.Java.examples.ciapi.dto.CreateSessionResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.SessionDeletionResponseDTO DeleteSession(String userName, String session,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.SessionDeletionResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.SessionDeletionResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.SessionDeletionResponseDTO) api.callPostMethod(fullUrl, userName,
					CIAPI.Java.examples.ciapi.dto.SessionDeletionResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public Future<Object> DeleteSessionAsync(String userName, String session, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, userName,
					CIAPI.Java.examples.ciapi.dto.SessionDeletionResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.GetPriceBarResponseDTO GetPriceBars(String marketId, String interval,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetPriceBarResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.GetPriceBarResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetPriceBarResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.GetPriceBarResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.GetPriceTickResponseDTO GetPriceTicks(String marketId, String priceTicks,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetPriceTickResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.GetPriceTickResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetPriceTickResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.GetPriceTickResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.GetMarketInformationResponseDTO GetMarketInformation(String marketId,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetMarketInformationResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.GetMarketInformationResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetMarketInformationResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.GetMarketInformationResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public Future<Object> GetMarketInformationAsync(String marketId, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.GetMarketInformationResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ListMarketInformationSearchResponseDTO ListMarketInformationSearch(
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListMarketInformationSearchResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListMarketInformationSearchResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListMarketInformationSearchResponseDTO) api.callPostMethod(fullUrl,
					null, CIAPI.Java.examples.ciapi.dto.ListMarketInformationSearchResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> ListMarketInformationSearchAsync(boolean searchByMarketCode, boolean searchByMarketName,
		...
		Future<Object> result;
		if (transport.equals("GET")) {
			result = call.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListMarketInformationSearchResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = call.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.ListMarketInformationSearchResponseDTO.class);
	 ...
	 * authorized to view all the markets in the supplied list, or the query
	 * will fail.
	 */
	@Override
	public CIAPI.Java.examples.ciapi.dto.ListMarketInformationResponseDTO ListMarketInformation(
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListMarketInformationResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListMarketInformationResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListMarketInformationResponseDTO) api.callPostMethod(fullUrl,
	...
	public Future<Object> ListMarketInformationAsync(
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, listMarketInformationRequestDTO,
					CIAPI.Java.examples.ciapi.dto.ListMarketInformationResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ListNewsHeadlinesResponseDTO ListNewsHeadlines(String category,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListNewsHeadlinesResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListNewsHeadlinesResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListNewsHeadlinesResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.ListNewsHeadlinesResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.GetNewsDetailResponseDTO GetNewsDetail(String storyId, JsonApi api)
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetNewsDetailResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.GetNewsDetailResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetNewsDetailResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.GetNewsDetailResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ListCfdMarketsResponseDTO ListCfdMarkets(String searchByMarketName,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListCfdMarketsResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListCfdMarketsResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListCfdMarketsResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.ListCfdMarketsResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ListSpreadMarketsResponseDTO ListSpreadMarkets(String searchByMarketName,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListSpreadMarketsResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListSpreadMarketsResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListSpreadMarketsResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.ListSpreadMarketsResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO Order(
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO) api.callPostMethod(fullUrl, order,
					CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO CancelOrder(
		...
		if (transport.equals("GET")) {
			...
			result = (CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO) api.callPostMethod(fullUrl, cancelOrder,
					CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public Future<Object> CancelOrderAsync(CIAPI.Java.examples.ciapi.dto.CancelOrderRequestDTO cancelOrder,
		...
		if (transport.equals("GET")) {
			...
			result = call.callPostMethod(fullUrl, cancelOrder,
					CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ListOrdersResponseDTO ListOrders(int tradingAccountId, boolean openOrders,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListOrdersResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListOrdersResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListOrdersResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.ListOrdersResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ListOpenPositionsResponseDTO ListOpenPositions(int tradingAccountId,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListOpenPositionsResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListOpenPositionsResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListOpenPositionsResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.ListOpenPositionsResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ListActiveStopLimitOrderResponseDTO ListActiveStopLimitOrders(
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListActiveStopLimitOrderResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListActiveStopLimitOrderResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListActiveStopLimitOrderResponseDTO) api.callPostMethod(fullUrl,
					null, CIAPI.Java.examples.ciapi.dto.ListActiveStopLimitOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public CIAPI.Java.examples.ciapi.dto.GetActiveStopLimitOrderResponseDTO GetActiveStopLimitOrder(String orderId,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetActiveStopLimitOrderResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.GetActiveStopLimitOrderResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetActiveStopLimitOrderResponseDTO) api.callPostMethod(fullUrl,
					null, CIAPI.Java.examples.ciapi.dto.GetActiveStopLimitOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public Future<Object> GetActiveStopLimitOrderAsync(String orderId, AsyncJsonApi api, CallBack... callBacks)
		...
		if (transport.equals("GET")) {
			result = call
					.callGetMethod(fullUrl, CIAPI.Java.examples.ciapi.dto.GetActiveStopLimitOrderResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = call.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.GetActiveStopLimitOrderResponseDTO.class);
		} else {
	...
	public CIAPI.Java.examples.ciapi.dto.GetOpenPositionResponseDTO GetOpenPosition(String orderId, JsonApi api)
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetOpenPositionResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.GetOpenPositionResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetOpenPositionResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.GetOpenPositionResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ListTradeHistoryResponseDTO ListTradeHistory(int tradingAccountId,
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListTradeHistoryResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListTradeHistoryResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListTradeHistoryResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.ListTradeHistoryResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public Future<Object> ListTradeHistoryAsync(int tradingAccountId, int maxResults, AsyncJsonApi api,
		...
		if (transport.equals("GET")) {
			...
			result = call
					.callPostMethod(fullUrl, null, CIAPI.Java.examples.ciapi.dto.ListTradeHistoryResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public CIAPI.Java.examples.ciapi.dto.ListStopLimitOrderHistoryResponseDTO ListStopLimitOrderHistory(
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListStopLimitOrderHistoryResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ListStopLimitOrderHistoryResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ListStopLimitOrderHistoryResponseDTO) api.callPostMethod(fullUrl,
					null, CIAPI.Java.examples.ciapi.dto.ListStopLimitOrderHistoryResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
		return result;
	...
	public CIAPI.Java.examples.ciapi.dto.GetOrderResponseDTO GetOrder(String orderId, JsonApi api) throws ApiException {
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetOrderResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.GetOrderResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.GetOrderResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.GetOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO Trade(
		...
		if (transport.equals("GET")) {
			...
			result = (CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO) api.callPostMethod(fullUrl, trade,
					CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO Update(
		...
		if (transport.equals("GET")) {
			...
			result = (CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO) api.callPostMethod(fullUrl, update,
					CIAPI.Java.examples.ciapi.dto.ApiTradeOrderResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
	...
	public CIAPI.Java.examples.ciapi.dto.ErrorResponseDTO GenerateException(int errorCode, JsonApi api)
		...
		if (transport.equals("GET")) {
			result = (CIAPI.Java.examples.ciapi.dto.ErrorResponseDTO) api.callGetMethod(fullUrl,
					CIAPI.Java.examples.ciapi.dto.ErrorResponseDTO.class);
		} else if (transport.equals("POST")) {
			result = (CIAPI.Java.examples.ciapi.dto.ErrorResponseDTO) api.callPostMethod(fullUrl, null,
					CIAPI.Java.examples.ciapi.dto.ErrorResponseDTO.class);
		} else {
			throw new IllegalArgumentException("Unexpected transport type: " + transport);
		}
